      ...
      "fulfillmentStartInstructions": [
        {
          ...
          "fulfillmentInstructionsType": "FulfillmentInstructionsType : [DIGITAL,PREPARE_FOR_PICKUP,SELLER_DEFINED,SHIP_TO]",
          ...
          "ebayCollectAndRemitTaxes": [
            {
              ...
              "taxType": "TaxTypeEnum : [GST,PROVINCE_SALES_TAX,REGION,STATE_SALES_TAX,VAT]",
        ...
        "payments": [
          {
            ...
            "paymentMethod": "PaymentMethodTypeEnum : [CREDIT_CARD,PAYPAL]",
